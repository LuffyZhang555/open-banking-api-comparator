     ...
     <Card>
      ...
      <Descriptions title={data.Brand[1].SavingsAccount[0].Name} bordered>
       ...
       <Descriptions.Item label="Eligibility"span={3}> 
         *{data.Brand[1].SavingsAccount[0].SavingsAccountMarketingState[0].Eligibility.AgeEligibility.Notes[0]}
         <br />
       ...
       <Descriptions.Item label="Features"span={3}>
         ...
         *{data.Brand[1].SavingsAccount[0].SavingsAccountMarketingState[0].FeaturesAndBenefits.FeatureBenefitItem[3].Name}:{data.Brand[1].SavingsAccount[0].SavingsAccountMarketingState[0].FeaturesAndBenefits.FeatureBenefitItem[3].Notes[0]}
         <br />
         *{data.Brand[1].SavingsAccount[0].SavingsAccountMarketingState[0].FeaturesAndBenefits.FeatureBenefitItem[4].Name}:{data.Brand[1].SavingsAccount[0].SavingsAccountMarketingState[0].FeaturesAndBenefits.FeatureBenefitItem[4].Notes[0]}
         <br />
         *{data.Brand[1].SavingsAccount[0].SavingsAccountMarketingState[0].FeaturesAndBenefits.FeatureBenefitItem[5].Name}:{data.Brand[1].SavingsAccount[0].SavingsAccountMarketingState[0].FeaturesAndBenefits.FeatureBenefitItem[5].Notes[0]}
       </Descriptions.Item>

       <Descriptions.Item label="Fee Charges" span={3}>
         *{data.Brand[1].SavingsAccount[0].SavingsAccountMarketingState[0].FeesCharges.FeeChargeDetail[0].Notes[0]}
